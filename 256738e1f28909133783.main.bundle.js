...
*/
  ...
  \************************************ */
      /***/ (
        ...
        /* harmony import */ const _main__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./main */ './src/scripts/main.js');
        /* harmony import */ const _domElements__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./domElements */ './src/scripts/domElements.js',
          );
        /* harmony import */ const _changeForecast__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./changeForecast */ './src/scripts/changeForecast.js',
          );
        /* harmony import */ const _currentWeatherAPI__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./currentWeatherAPI */ './src/scripts/currentWeatherAPI.js',
          );

        const autoSearchContainer = document.querySelector(
          '.location__auto-search',
        );
        ...
        async function autoComplete(search) {
          ...
          if (currentData.length > 0) {
            ...
            currentData.forEach(async (location) => {
              ...
              const listLocation = (0,
              _domElements__WEBPACK_IMPORTED_MODULE_1__.newList)(
                'auto-search__location',
              );
              ...
              listLocation.addEventListener('click', () => {
                ...
                (0,
                _currentWeatherAPI__WEBPACK_IMPORTED_MODULE_3__.currentWeather)();
                (0,
                _changeForecast__WEBPACK_IMPORTED_MODULE_2__.changeForecast)();
  ...
  \********************************* */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ changeCloudCoverage: () =>
            /* binding */ changeCloudCoverage,
          /* harmony export */ changeCurrentCondition: () =>
            /* binding */ changeCurrentCondition,
          /* harmony export */ changeCurrentHumidity: () =>
            /* binding */ changeCurrentHumidity,
          /* harmony export */ changeCurrentImage: () =>
            /* binding */ changeCurrentImage,
          /* harmony export */ changeCurrentTemp: () =>
            /* binding */ changeCurrentTemp,
          /* harmony export */ changeCurrentUV: () =>
            /* binding */ changeCurrentUV,
          /* harmony export */ changeLocation: () =>
            /* binding */ changeLocation,
          /* harmony export */ changeRainChance: () =>
            /* binding */ changeRainChance,
          /* harmony export */ changeWindDirection: () =>
            /* binding */ changeWindDirection,
          /* harmony export */ changeWindSpeed: () =>
            /* binding */ changeWindSpeed,
          /* harmony export */
        });
  ...
  \************************************** */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ changeForecast: () =>
            /* binding */ changeForecast,
          /* harmony export */
        });
        /* harmony import */ const _main__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./main */ './src/scripts/main.js');
        ...
        /* harmony import */ const _changeDOM__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./changeDOM */ './src/scripts/changeDOM.js');
        /* harmony import */ const _changeForecastDOM__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./changeForecastDOM */ './src/scripts/changeForecastDOM.js',
          );
        ...
        async function changeForecast() {
          try {
            ...
            for (let i = 1; i < 4; i++) {
              ...
              (0, _changeForecastDOM__WEBPACK_IMPORTED_MODULE_3__.changeDay)(
                day,
                date,
                condition,
                image,
            ...
            console.log(error);
            _domElements__WEBPACK_IMPORTED_MODULE_1__.errorState.style.visibility =
              'visible';
          }
        }
  ...
  \***************************************** */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ currentWeather: () =>
            /* binding */ currentWeather,
          /* harmony export */
        });
        /* harmony import */ const _domElements__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./domElements */ './src/scripts/domElements.js',
          );
        /* harmony import */ const _main__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./main */ './src/scripts/main.js');
        /* harmony import */ const _changeForecast__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./changeForecast */ './src/scripts/changeForecast.js',
          );
        /* harmony import */ const _changeDOM__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./changeDOM */ './src/scripts/changeDOM.js');
        ...
        async function currentWeather() {
          ...
          try {
            ...
            const currentData = await response.json();
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCurrentCondition)(
            ...
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCurrentImage)(
              currentData.current.condition.icon,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCurrentTemp)(
              currentData.current.feelslike_f,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCurrentHumidity)(
              currentData.current.humidity,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCurrentUV)(
              currentData.current.uv,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeWindSpeed)(
              currentData.current.gust_mph,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeWindDirection)(
              currentData.current.wind_dir,
            );
            (0, _changeDOM__WEBPACK_IMPORTED_MODULE_3__.changeCloudCoverage)(
              currentData.current.cloud,
            );
            document.documentElement.style.setProperty(
              '--visible-state',
              'visible',
            ...
            _domElements__WEBPACK_IMPORTED_MODULE_0__.errorState.style.visibility =
              'visible';
          }
        }
  ...
  \*********************************** */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ createListElement: () =>
            /* binding */ createListElement,
  ...
  \**************************** */
      /***/ (
        ...
        /* harmony import */ const _styles_styles_css__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../styles/styles.css */ './src/styles/styles.css',
          );
        /* harmony import */ const _currentWeatherAPI__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./currentWeatherAPI */ './src/scripts/currentWeatherAPI.js',
          );
        /* harmony import */ const _domElements__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./domElements */ './src/scripts/domElements.js',
          );
        /* harmony import */ const _changeForecast__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./changeForecast */ './src/scripts/changeForecast.js',
          );
        /* harmony import */ const _autoComplete__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ./autoComplete */ './src/scripts/autoComplete.js',
          );
        ...
        _domElements__WEBPACK_IMPORTED_MODULE_2__.searchButton.addEventListener(
          'click',
          () => {
            (0,
            _currentWeatherAPI__WEBPACK_IMPORTED_MODULE_1__.currentWeather)();
          ...
          document
            ...
            .addEventListener('keypress', (event) => {
              if (event.key === 'Enter') {
                ...
                _currentWeatherAPI__WEBPACK_IMPORTED_MODULE_1__.currentWeather)();
                (0,
                _changeForecast__WEBPACK_IMPORTED_MODULE_3__.changeForecast)();
                _domElements__WEBPACK_IMPORTED_MODULE_2__.searchValue.value =
                  '';
                _domElements__WEBPACK_IMPORTED_MODULE_2__.errorState.style.visibility =
                  'hidden';
                ulListContainer.style.display = 'none';
              } else {
                (0, _autoComplete__WEBPACK_IMPORTED_MODULE_4__.autoComplete)(
                  _domElements__WEBPACK_IMPORTED_MODULE_2__.searchValue.value,
                );
              }
            });
